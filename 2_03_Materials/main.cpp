...
int main()
{
	...
	*/
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// material properties
		glUniform3f(glGetUniformLocation(cubeShader.ID, "material.ambient"), 1.0f, 0.5f, 0.31f);
		glUniform3f(glGetUniformLocation(cubeShader.ID, "material.diffuse"), 1.0f, 0.5f, 0.31f);
