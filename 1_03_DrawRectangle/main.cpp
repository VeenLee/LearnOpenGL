//
// 使用 顶点数组对象(Vertex Array Object，VAO) 和 顶点缓冲对象(Vertex Buffer Object，VBO) 
//   和 索引缓冲对象(Element Buffer Object，EBO，也叫Index Buffer Object，IBO) 绘制矩形
//
...
int main()
{
	...
	*/
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//glPolygonMode(GL_FRONT_AND_BACK, GL_LINE); //线框模式(Wireframe Mode)，显示线段，多边形用轮廓显示
		glPolygonMode(GL_FRONT_AND_BACK, GL_FILL); //显示面，多边形采用填充形式
